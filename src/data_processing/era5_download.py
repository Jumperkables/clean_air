...
# Local Imports
from utils import *
from era5_process import find_closest_float
...
if __name__ == "__main__":
    ...
    for r_idx, row in enumerate(tqdm(waqi_stations, total=len(waqi_stations))):
        lat = row["g"][0]
        lon = row["g"][1]
        uid = row["x"]
        # grib0
        ...
        coordinates.append({
            "latitude":  closest_lat_grib12,
            "longitude": closest_lon_grib12,
        })
        area = [ 
            #lat+radius_in_degree,   # North
            #lon-radius_in_degree,   # West
            #lat-radius_in_degree,   # South
            #lon+radius_in_degree    # East
            closest_lat_grib12,     # North
            closest_lon_grib12,     # West
            closest_lat_grib12,     # South
            closest_lon_grib12      # East
        ]
        save_path = os.path.join( ERA5_PATH , f"{uid}.grib" )
        c.retrieve(
    ...
    #    #lon = w_stat["g"][1]
    #    #uid = w_stat["x"]
    #    #radius_in_degree = RADIUS_AROUND_STATION/111000
    #    #radius_in_degree = radius_in_degree/10
    #    ## Reduce needed data by factor of 10000
    #    area = [ 
    #        #lat+radius_in_degree,   # North
    #    	#lon-radius_in_degree,   # West
    #        #lat-radius_in_degree,   # South
    ...
    #    ]
    #    #for mont in month:
    #    #save_path = os.path.join( ERA5_PATH , f"{uid}_{mont}.nc" )
    #    save_path = os.path.join( ERA5_PATH , f"day-{da}.grib" )
    #    c.retrieve(
    #        'reanalysis-era5-single-levels',
    #        {
    #            'product_type': 'reanalysis',
